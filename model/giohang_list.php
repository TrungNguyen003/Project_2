<?php
    ...
    from  duyetdon join nguoidung on nguoidung.IDNguoiDung=duyetdon.idnguoidung join sanpham on sanpham.id=duyetdon.idSP WHERE nguoidung.IDNguoiDung=:sid and duyetdon.trangthai=0";
