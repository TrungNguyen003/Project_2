...
?>
  ...
  <body>
    ...
    <div class="main-content">
      ...
      <div class="category">
        <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a class="line">|</a> &nbsp;&nbsp;&nbsp;<a href="#">Danh mục sản phẩm<a> | <a href="#">Thúc cưng</a></h5>
      </div>
    </div>
    <!--  -->
    <section>
      <div class="content-wrapper">
        <div class="container">
          <div class="row pad-botm">
            <div class="col-md-12">
              <h2 class="header-line">Thú cưng</h2>
              <div class="linee">
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="panel-body">
                  <?php 
                  include_once("../model/thucung_list.php");
                  $cnt = 1;
                  if ($query->rowCount() > 0) {
                    foreach ($results as $result) {               ?>
                      <div class="col-md-3" style="float:left;">
                        <figure class="snip1205">
                          <a href="trangchitiet_view.php?idsp=<?php echo htmlentities($result->idsp); ?>"><img src="../admin/img/<?php echo htmlentities($result->HinhSP); ?>" width="250" height="300px"></a><br>
