...
if (strlen($_SESSION['login']) == 0) {
    ...
    include('../controller/update_xacnhandon.php');
?>
    <!DOCTYPE html>
    <html>
        ...
        <div class="content-wrapper">
            <div class="container">
                <div class="row pad-botm">
                    <div class="col-md-12">
                        <h4 class="header-line" align="center">Xác nhận đơn hàng</h4>
                                    ...
                                    if ($query->rowCount() > 0) {
                                        foreach ($results as $result) {               ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    if ($result->trangthai == 0) {
                                                        ...
                                                        echo htmlentities("Xác nhận đã nhận hàng");
                                                    } else {
                                            ...
                                            <?php if ($result->trangthai == 4) { ?>
                                                <button type="submit" name="return" id="submit" class="btn btn-success">Đã nhận</button>
